...
CREATE INDEX IF NOT EXISTS idx_inventory_intake_jobs_parent_batch_job_id ON public.inventory_intake_jobs(parent_batch_job_id);  
...
ALTER TABLE public.inventory_intake_jobs DROP CONSTRAINT IF EXISTS fk_inventory_intake_jobs_parent_batch_job_id;

ALTER TABLE public.inventory_intake_jobs
  ADD CONSTRAINT fk_inventory_intake_jobs_parent_batch_job_id
  FOREIGN KEY (parent_batch_job_id)
  REFERENCES public.inventory_intake_batch_jobs(id);
