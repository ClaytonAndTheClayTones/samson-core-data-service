...
class HistoricalSaleDataAccessor:
    ...
    def insert(self, model: HistoricalSaleCreateModel):
        ...
        db_result: dict[str, Any] = connection.insert('historical_sales',
                                                      db_model)
    ...
    def select_by_id(self, id: UUID):
        ...
        db_result = connection.select_by_id('historical_sales', id)
    ...
    def select(
        ...
        db_result: SelectQueryResults = connection.select(
            'historical_sales', search_terms, paging_model)

        results: ItemList[HistoricalSaleModel] = ItemList[HistoricalSaleModel](
            db_result.paging)
    ...
    def delete(self, id: UUID):
        ...
        db_result = connection.delete('historical_sales', id)
