...
class InventoryProductSnapshotDataAccessor:
    ...
    def insert(self, model: InventoryProductSnapshotCreateModel):
        ...
        db_result: dict[str, Any] = connection.insert('inventory_product_snapshots',
                                                      db_model)
    ...
    def select_by_id(self, id: UUID):
        ...
        db_result = connection.select_by_id('inventory_product_snapshots', id)
    ...
    def select(
        ...
        db_result: SelectQueryResults = connection.select(
            'inventory_product_snapshots', search_terms, paging_model)

        results: ItemList[InventoryProductSnapshotModel] = ItemList[InventoryProductSnapshotModel](
            db_result.paging)
    ...
    def delete(self, id: UUID):
        ...
        db_result = connection.delete('inventory_product_snapshots', id)
