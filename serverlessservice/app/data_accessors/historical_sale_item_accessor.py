...
class HistoricalSaleItemDataAccessor:
    ...
    def insert(self, model: HistoricalSaleItemCreateModel):
        ...
        db_result: dict[str, Any] = connection.insert('historical_sale_items',
                                                      db_model)
    ...
    def select_by_id(self, id: UUID):
        ...
        db_result = connection.select_by_id('historical_sale_items', id)
    ...
    def select(
        ...
        db_result: SelectQueryResults = connection.select(
            'historical_sale_items', search_terms, paging_model)

        results: ItemList[HistoricalSaleItemModel] = ItemList[HistoricalSaleItemModel](
            db_result.paging)
    ...
    def delete(self, id: UUID):
        ...
        db_result = connection.delete('historical_sale_items', id)
