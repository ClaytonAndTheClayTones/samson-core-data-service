...
from models.vendor_model import VendorInboundCreateModel, VendorInboundSearchModel, VendorInboundUpdateModel, VendorOutboundModel
...
def set_routes(app: FastAPI):
        ...
        @app.get("/vendors", response_model= OutboundItemListResponse[VendorOutboundModel])
        def get_vendors(inbound_search_model: VendorInboundSearchModel = Depends()) -> OutboundItemListResponse[VendorOutboundModel]: 
        ...
        def patch_vendor(id: UUID4, inbound_update_model: VendorInboundUpdateModel): 
