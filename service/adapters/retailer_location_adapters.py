...
from models.retailer_location_model import RetailerLocationCreateModel, RetailerLocationDatabaseModel, RetailerLocationInboundCreateModel, RetailerLocationInboundSearchModel, RetailerLocationInboundUpdateModel, RetailerLocationModel, RetailerLocationOutboundModel, RetailerLocationSearchModel, RetailerLocationUpdateModel
...
class RetailerLocationDataAdapter():  
    ...
    def convert_from_inbound_create_model_to_create_model(self, inbound_create_model: RetailerLocationInboundCreateModel) -> RetailerLocationCreateModel:
    ...
    def convert_from_inbound_update_model_to_create_model(self, inbound_update_model: RetailerLocationInboundUpdateModel) -> RetailerLocationUpdateModel:
    ...
    def convert_from_inbound_search_model_to_search_model(self, inbound_search_model: RetailerLocationInboundSearchModel) -> RetailerLocationSearchModel:
        model = RetailerLocationSearchModel(
            ...
            retailer_ids = self.common_utilities.convert_comma_delimited_ids_to_uuid_list(inbound_search_model.retailer_ids) if inbound_search_model.retailer_ids is not None else None,
            pos_integration_ids = self.common_utilities.convert_comma_delimited_ids_to_uuid_list(inbound_search_model.pos_integration_ids) if inbound_search_model.pos_integration_ids is not None else None,
    ...
    def convert_from_search_model_to_search_terms(self, model: RetailerLocationSearchModel) -> list[SearchTerm]:
    ...
    def convert_from_database_model_to_model(self, database_model: dict[str, Any]) -> RetailerLocationModel:
    ...
    def convert_from_model_to_outbound_model(self, model: RetailerLocationModel) -> RetailerLocationOutboundModel:
