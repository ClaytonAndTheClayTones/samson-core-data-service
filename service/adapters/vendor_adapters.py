...
class VendorDataAdapter:
    ...
    def convert_from_inbound_create_model_to_create_model(
        self, inbound_create_model: VendorInboundCreateModel
    ) -> VendorCreateModel:
    ...
    def convert_from_inbound_update_model_to_create_model(
        self, inbound_update_model: VendorInboundUpdateModel
    ) -> VendorUpdateModel:
    ...
    def convert_from_search_model_to_search_terms(
        ...
        if model.name_like is not None:
            search_terms.append(
                LikeSearchTerm(
                    'name', model.name_like, LikeComparatorModes.Like, True
                )
            )
