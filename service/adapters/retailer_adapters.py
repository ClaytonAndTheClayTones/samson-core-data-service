...
from models.retailer_model import RetailerCreateModel, RetailerDatabaseModel, RetailerInboundCreateModel, RetailerInboundSearchModel, RetailerInboundUpdateModel, RetailerModel, RetailerOutboundModel, RetailerSearchModel, RetailerUpdateModel
...
class RetailerDataAdapter():  
    ...
    def convert_from_inbound_create_model_to_create_model(self, inbound_create_model: RetailerInboundCreateModel) -> RetailerCreateModel:
    ...
    def convert_from_inbound_update_model_to_create_model(self, inbound_update_model: RetailerInboundUpdateModel) -> RetailerUpdateModel:
    ...
    def convert_from_inbound_search_model_to_search_model(self, inbound_search_model: RetailerInboundSearchModel) -> RetailerSearchModel:
    ...
    def convert_from_search_model_to_search_terms(self, model: RetailerSearchModel) -> list[SearchTerm]:
    ...
    def convert_from_create_model_to_database_model(self, model: RetailerCreateModel) -> dict[str, Any]:
    ...
    def convert_from_update_model_to_database_model(self, model: RetailerUpdateModel) -> dict[str, Any]:
        database_model: dict[str, Any] = {
            "name" : model.name,
            "hq_state" : model.hq_state,
            "hq_city" : model.hq_city,
    ...
    def convert_from_database_model_to_model(self, database_model: dict[str, Any]) -> RetailerModel:
        model = RetailerModel(
    ...
    def convert_from_model_to_outbound_model(self, model: RetailerModel) -> RetailerOutboundModel:
