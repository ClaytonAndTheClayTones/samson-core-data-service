...
from models.common_model import CommonDatabaseModel, CommonInboundSearchModel, CommonModel, CommonOutboundResponseModel, CommonSearchModel, DicsPhoneNumber, validate_ids
...
class VendorInboundCreateModel(BaseModel):   
    ...
    registered_replacement_vendor_id: Optional[Annotated[UUID4, Strict(False)]] = Field(default = None)
...
class VendorInboundSearchModel(CommonInboundSearchModel):
    ...
    registered_replacement_vendor_ids: Annotated[Optional[str], BeforeValidator(validate_ids)] = Query(default = None) 
