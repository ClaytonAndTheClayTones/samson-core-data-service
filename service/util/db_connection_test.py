...
from util.database import ExactMatchSearchTerm, InListSearchTerm, LikeComparatorModes, LikeSearchTerm, PagingModel, RangeSearchTerm, SearchTerm
...
def test_build_select_query():
    ...
    exact_match_search_term = ExactMatchSearchTerm(
        "test_col_exact",
        1234
    ) 
    
    like_match_search_term = LikeSearchTerm("test_col_like", "likesearch", LikeComparatorModes.Like)
    
    in_list_match_search_term = InListSearchTerm("test_col_list", ["abc","def","ghi"], False)
    
    range_match_search_term = RangeSearchTerm("test_col_range", 111, 222, False)
...
def test_build_select_query_with_set_paging_fields():
    ...
    paging = PagingModel(is_sort_descending=True, page = 12, page_length=5, sort_by="sortablecolumn")
...
def test_build_select_query_with_bad_paging_fields():
    ...
    paging = PagingModel(is_sort_descending=True, page = -1, page_length = 1005, sort_by = "sortablecolumn")
