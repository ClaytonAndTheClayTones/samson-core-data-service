...
class PGConnection:
    ...
    def select(
        ...
        buildqueryresults = self.build_select_query(
            tablename, search_terms, paging_model
        )
    ...
    def build_select_query(
        ...
        is_sort_descending = (
            True if paging_model.is_sort_descending == True else False
        )
        ...
        return_object = BuildSelectQueryResults(
            sqlstring=sqlstring, paging=resultant_paging_model
        )
    ...
    def build_update_query(
        self, table_name: str, id: UUID, model: dict[str, Any]
    ):
