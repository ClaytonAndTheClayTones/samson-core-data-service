...
from util.database import ExactMatchSearchTerm, InListSearchTerm, LikeComparatorModes, LikeSearchTerm, RangeSearchTerm
...
def test_like_search_term_generates_sql_as_starts_with():
    search_term = LikeSearchTerm("test_column", "A String", LikeComparatorModes.StartsWith)
...
def test_like_search_term_generates_sql_as_ends_with():
    search_term = LikeSearchTerm("test_column", "A String", LikeComparatorModes.EndsWith)
...
def test_like_search_term_generates_sql_as_like_ignore_case():
    search_term = LikeSearchTerm("test_column", "A String", LikeComparatorModes.Like, True)
...
def test_in_list_search_term_generates_sql_ignore_case():
    search_term = InListSearchTerm("test_column",  ["string 1", "string 2", "string 3"], True)
