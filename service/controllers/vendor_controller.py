...
class VendorController():  
    def create(self, inbound_model: VendorInboundCreateModel) -> VendorOutboundModel | None:
    ...
    def search(self, inbound_model: VendorInboundSearchModel) -> OutboundItemListResponse[VendorOutboundModel]: 
        ...
        results: ItemList[VendorModel] = manager.search(search_model, paging_model)
    ...
    def update(self, id: UUID, inbound_model: VendorInboundUpdateModel, explicitNullSet: list[str] | None = None):
           
        explicitNullSet = explicitNullSet or []

        model: VendorUpdateModel = adapter.convert_from_inbound_update_model_to_create_model(inbound_model)
