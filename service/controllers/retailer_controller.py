...
class RetailerController():  
    def create(self, inbound_model: RetailerInboundCreateModel) -> RetailerOutboundModel | None:
    ...
    def search(self, inbound_model: RetailerInboundSearchModel) -> OutboundItemListResponse[RetailerOutboundModel]: 
        ...
        results: ItemList[RetailerModel] = manager.search(search_model, paging_model)
    ...
    def update(self, id: UUID, inbound_model: RetailerInboundUpdateModel, explicitNullSet: list[str] | None = None):
           
        explicitNullSet = explicitNullSet or []

        model: RetailerUpdateModel = adapter.convert_from_inbound_update_model_to_create_model(inbound_model)
