...
from routes.retailer_location_routes import (
    set_routes as set_retailer_location_routes, )
from routes.pos_integration_routes import (
    set_routes as set_pos_integration_routes, )
